...
function render_game_age_rating_text_pegi($id) {
    ...
    switch($pegi) {
        case 1: echo '<div style="margin-bottom: 1rem;">Age 3</div>'; break;
        case 2: echo '<div style="margin-bottom: 1rem;">Age 7</div>'; break;
        case 3: echo '<div style="margin-bottom: 1rem;">Age 12</div>'; break;
        case 4: echo '<div style="margin-bottom: 1rem;">Age 16</div>'; break;
        case 5: echo '<div style="margin-bottom: 1rem;">Age 18</div>'; break;
    }
}
...
function render_game_age_rating_text_esrb($id) {
    ...
    switch($esrb) {
        case 6: echo '<div style="margin-bottom: 1rem;">Rating Pending</div>'; break;
        case 7: echo '<div style="margin-bottom: 1rem;">Early Childhood</div>'; break;
        case 8: echo '<div style="margin-bottom: 1rem;">Everyone</div>'; break;
        case 9: echo '<div style="margin-bottom: 1rem;">Everyone Ten Plus</div>'; break;
        case 10: echo '<div style="margin-bottom: 1rem;">Teen</div>'; break;
        case 11: echo '<div style="margin-bottom: 1rem;">Mature</div>'; break;
        case 12: echo '<div style="margin-bottom: 1rem;">Adults Only</div>'; break;
    }
}
